...
ConditionalRingBuffer<ElementType, ConditionValueType, Size, true>::ConditionalRingBuffer(element_type_ptr_t elements)
  : internal::conditional_elements_ring_range_t<ElementType, ConditionValueType, Size, true, ConditionalRingBuffer>{}
  , elements_{ elements }
{
}
