...
void CommandList::releaseResourceToGraphics(PipelineStageFlagBits srcStageMask,
                                            PipelineStageFlagBits dstStageMask,
                                            AccessFlagBits srcAccessMask,
                                            AccessFlagBits dstAccessMask,
                                            core::ResourceSharedRef& resourceRef,
...
void CommandList::releaseResourceToTransfer(PipelineStageFlagBits srcStageMask,
                                            PipelineStageFlagBits dstStageMask,
                                            AccessFlagBits srcAccessMask,
                                            AccessFlagBits dstAccessMask,
                                            core::ResourceSharedRef& resourceRef,
