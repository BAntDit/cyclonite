                 ...
                 updateStageCount>
{
    ...
    using entity_manager_t =
      enttx::EntityManager<enttx::EntityManagerConfig<scene_component_list_t, scene_storage_list_t>>;

    using system_manager_t =
      enttx::EntityManager<enttx::SystemManagerConfig<updateStageCount, entity_manager_t, scene_system_list_t>>;
};
