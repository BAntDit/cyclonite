...
main(int argc, char* argv[])
{
  ...
  desc.add_options()("help", "Produce help message")(
    ...
    "mdvc-fallback, vi")("fdiagnostics-show-option",
    ...
    "Fo", "Output file")("Fre", "Output reflection to the given file")(
    "Frs", "Output root signature to the given file")(
    "Fsh", "Output shader hash to the given file")(
    "Gec", "Enable backward compatibility mode")("Ges", "Enable strict mode")(
    "Gfa", "Avoid flow control constructs")(
    "Gfp", "Prefer flow control constructs")("Gis", "Force IEEE strictness")(
    "HV", "HLSL version (2016, 2017, 2018, 2021). Default is 2021")(
    "ignore-line-directives",
    "Ignore line directives")("I", "Add directory to include search path")(
    "Ni", "Output instruction numbers in assembly listings")(
    "no-warnings", "Suppress warnings")("Od", "Disable optimizations")(
    "pack-optimized",
    ...
    "as_6_7, as_6_8, as_6_9")("Vd", "Disable validation")(
    ...
    "optimization configuration (see http://khr.io/hlsl2spirv#optimization)")(
    "spirv", "Generate SPIR-V code")("P", "Preprocess to file")(
    "Qembed_debug", "Embed PDB in shader container (must be used with /Zi)")(
    "Qsource_in_debug_module",
    "Embed source code in PDB")("Qstrip_debug",
                                "Strip debug information from 4_0+ shader "
                                "bytecode (must be used with /Fo )")(
    "Qstrip_rootsignature",
    "Strip root signature data from shader bytecode (must be used with /Fo )")(
