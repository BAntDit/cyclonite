...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("E", "Entry point name")
        ("fdiagnostics-format", "Select diagnostic message format. Supported values: clang, msvc, mdvc-fallback, vi")
        ...
        ("Fd", "Write debug information to the given file, or automatically named file in directory")
        ...
        ("T", "Set target profile. profile: ps_6_0, ps_6_1, ps_6_2, ps_6_3, ps_6_4, ps_6_5, ps_6_6, ps_6_7, ps_6_8, ps_6_9, vs_6_0, vs_6_1, vs_6_2, vs_6_3, vs_6_4, vs_6_5, vs_6_6, vs_6_7, vs_6_8, vs_6_9, gs_6_0, gs_6_1, gs_6_2, gs_6_3, gs_6_4, gs_6_5, gs_6_6, gs_6_7, gs_6_8, gs_6_9, hs_6_0, hs_6_1, hs_6_2, hs_6_3, hs_6_4, hs_6_5, hs_6_6, hs_6_7, hs_6_8, hs_6_9, ds_6_0, ds_6_1, ds_6_2, ds_6_3, ds_6_4, ds_6_5, ds_6_6, ds_6_7, ds_6_8, ds_6_9, cs_6_0, cs_6_1, cs_6_2, cs_6_3, cs_6_4, cs_6_5, cs_6_6, cs_6_7, cs_6_8, cs_6_9, lib_6_1, lib_6_2, lib_6_3, lib_6_4, lib_6_5, lib_6_6, lib_6_7, lib_6_8, lib_6_9, ms_6_5, ms_6_6, ms_6_7, ms_6_8, ms_6_9, as_6_5, as_6_6, as_6_7, as_6_8, as_6_9")
        ...
        ("decl-global-cb", "Collect all global constants outside cbuffer declarations into cbuffer GlobalCB")
        ...
        ("fspv-enable-maximal-reconvergence", "Enables the MaximallyReconvergesKHR execution mode for this module.")
        ...
        ("fspv-flatten-resource-arrays", "Flatten arrays of resources so each array element takes one binding number.")
        ("fspv-max-id", "Set the maximum value for an id in the SPIR-V binary. Default is 0x3FFFFF, which is the largest value all drivers must support.")
        ...
        ("fspv-use-vulkan-memory-model", "Generates SPIR-V modules that use the Vulkan memory model instead of GLSL450.")
        ...
        ("fvk-support-nonzero-base-vertex", "Follow Vulkan spec to use gl_BaseVertex as the first vertex, which makes SV_VertexID = gl_VertexIndex - gl_BaseVertex (without this option, SV_VertexID = gl_VertexIndex)")
